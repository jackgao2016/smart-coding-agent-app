...
os.environ["OPENAI_MODEL_NAME"] = 'qwen3-coder:30b'
...
# 执行
print("正在启动多智能体协作，开始生成游戏代码...\n")
crew_result = crew.kickoff()  # 接收 CrewOutput 实例
game_code = crew_result.raw   # 提取纯字符串，解决类型不匹配问题
...
with open(filename, 'w', encoding='utf-8') as file:
    file.write(game_code)  # 此时 game_code 为 str 类型，可正常写入
